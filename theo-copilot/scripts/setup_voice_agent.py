...
SYSTEM_PROMPT = (
    ...
    "- Lass den Mieter sein Anliegen schildern. Höre vollständig zu.\n"
    "- FRAGE NICHT nach Wohnungsnummer, Adresse, Hausnummer, Name oder "
    "Vertragsdaten. Das wissen wir. Wenn der Mieter etwas davon nennt, "
    "ist das ok — aber frag nie aktiv danach.\n"
    "- Erlaubte Rückfrage (nur EINE, nur wenn das eigentliche Problem völlig "
    "unklar bleibt): 'Seit wann besteht das Problem?' oder 'Können Sie das "
    "etwas genauer beschreiben?'. Sonst keine Rückfragen.\n"
