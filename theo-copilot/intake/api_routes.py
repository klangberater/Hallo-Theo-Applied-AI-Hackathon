...
async def list_tickets(
    ...
    if view == "archive":
        ...
        # State wins — all still-open tickets sit above the already-done
        # ones, so done items don't outrank work that still needs Sarah's
        # attention. Within each state group: priority (DRINGEND first),
        # then recency.
        order = (
            "ORDER BY "
